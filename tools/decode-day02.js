#!/usr/bin/env node
/* =====================================================================
   Decode Day 02 submission codes into rows for the "Degrees JS EW" tab.

   Usage:
     node tools/decode-day02.js codes.txt          -> prints a table
     node tools/decode-day02.js codes.txt --csv    -> CSV for the sheet
     node tools/decode-day02.js D2.1Q.ZZZ… --csv   -> a single code
   ...
   Day 02 has its own salt, code prefix and check list, so this reads
   codec-day02.js + checks-day02.json. Day 01 codes are rejected.
   ===================================================================== */

const fs = require("fs");
const path = require("path");
const { decodeSubmission } = require("./codec-day02.js");
const roster = require("./roster.json");
const meta = require("./checks-day02.json");   // { total, required, optional, labels[] }
...
if (!target) {
  console.error("Usage: node tools/decode-day02.js <codes.txt | code> [--csv]");
  process.exit(1);
}
